        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">На этом курсе будем учиться фреймворку Laravel.
                        В конечном итоге должен будет получиться сайт новостей.</p>
                </div>
                <div class="col-sm-4 offset-md-1 py-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        {{--                        <li><a class="text-white" href="{{ route('news.create') }}">ADD NEWS</a></li>--}}
                        {{--                        <li><a class="text-white" href="{{ route('about.index') }}">ABOUT</a></li>--}}
